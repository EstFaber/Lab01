...
public class Calculadora{
    ...
    static  void mostrarMenu() {
        ...
        System.out.println("11. Fibonacci (n-ésimo)");
        System.out.println("12. Mínimo Común Múltiplo");
        System.out.println("13. Máximo Común Divisor");
    ...
    static void resta(Scanner sc) {
        System.out.print("Ingrese número a restar: ");
        valorActual -= sc.nextDouble();
    }
    ...
    static void raizEnesima(Scanner sc) {
        ...
        if (indice == 0) {
            System.out.println("❌ Error: índice no puede ser 0.");
            return;
        }
        if (valorActual < 0 && indice % 2 == 0) {
            System.out.println("❌ Error: resultado imaginario para raíces pares de negativos.");
            return;
        }
